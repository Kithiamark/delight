...
const CreatePodcastModal = ({ isOpen, onClose, onCreate }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Add Podcast Episode">
      <form onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className="mt-6 w-full bg-purple-600 text-white px-6 py-3 rounded-lg hover:bg-purple-700 transition-colors flex items-center justify-center"
        >
